...
- `python gen_balanced.py --sample_generator_factor 5 --random_sample_factor 5 --vote_rounds 20 -ep 50 --noise_multiplier_vote 1 --gen-batch-size 5000 --data 2d -noise 5. --synth-spec-string norm_k5_n100000_row5_col5_noise0.2  --gen-spec 200,500,500,200 --rff-sigma 0.50 -lr 3e-3 --d-rff 30000 `
#### DP-CGAN
