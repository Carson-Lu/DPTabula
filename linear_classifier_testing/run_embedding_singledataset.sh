#!/bin/bash
#SBATCH --job-name=embedding_singledataset
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/carson/scratch/logs/embedding_singledataset_%j.out
#SBATCH --error=/home/carson/scratch/logs/embedding_singledataset_%j.err
...
DATA_FILE="${DATA_SRC}/${DATA_FILENAME}"
...
python -u ./embedding_linear_singledataset.py \
       ...
       --results_path "${RESULTS_DIR}/${MODEL_NAME}_singledataset_result_${SLURM_JOB_ID}.txt" \
       --batch_size "${BATCH_SIZE}"

echo "Done! Results saved to ${RESULTS_DIR}/${MODEL_NAME}_singledataset_result_${SLURM_JOB_ID}.txt"
