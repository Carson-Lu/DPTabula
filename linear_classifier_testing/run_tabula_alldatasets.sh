#!/bin/bash
#SBATCH --job-name=llama-alldatasets
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/carson/scratch/logs/llama_alldatasets_%j.out
#SBATCH --error=/home/carson/scratch/logs/llama_alldatasets_%j.err

# ----- Define paths -----
PROJECT_SRC=/home/carson/DPTabula
DATA_SRC=/home/carson/scratch/data
MODEL_SRC=/home/carson/scratch/hf_models/Meta-Llama-3-8B
...
python -u ./tabula_linear_alldatasets.py \
    ...
    --results_path ${RESULTS_DIR}/llama_multidata_results_${SLURM_JOB_ID}.txt \
    --batch_size ${BATCH_SIZE}

# ----- Completion message -----
echo "Done! Results saved to ${RESULTS_DIR}/llama_multidata_results_${SLURM_JOB_ID}.txt"
