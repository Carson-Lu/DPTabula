...
class PrivSyn():
    def __init__(self, args, df, domain, rho, parent_dir):
        ########################################### preprocess ###########################################
        ...
        self.data_store = DataStore(self.args, parent_dir) # DataStore handles everything about data including reading and writing.
